...
"""
"""
K线AI分析服务 - 处理AI驱动的图表分析

使用大语言模型对K线图表进行智能分析，识别价格形态、
趋势方向和潜在的交易机会。

核心功能：
1. 图表分析：基于K线数据生成市场分析报告
2. 形态识别：识别常见的K线形态和技术图形
3. 趋势判断：判断当前市场趋势方向和强度
4. 多指标整合：结合市场流量指标进行综合分析

技术架构：
- 数据格式化：将K线数据转换为AI可理解的文本格式
- 提示词工程：使用优化的提示词模板引导AI分析
- 多模型支持：支持不同的LLM API进行分析
- 结果持久化：保存分析结果用于回顾和学习
